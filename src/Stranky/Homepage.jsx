...
function Homepage() {
    return (
          <Parallax pages={4} className="relative">
            ...
            <div
              className="w-full h-[25%] overflow-hidden bg-cover bg-center flex justify-center items-center relative"
              style={{ background: `url(${backgroundVideo})` }}
            >
              <div
                className="absolute inset-0 z-0 flex justify-center items-center"
                style={{
                  background: "radial-gradient(circle, rgba(0, 0, 0, 0.5) 50%, rgba(0, 0, 0, 1) 90%), linear-gradient(to top, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0) 60%)"
                }}
              />
