...
function App() {
  ...
  const slider = [
    ...
    },
    {
        ...
        tag: {0: ["svajciarsko", "pamiatka", "priroda"], 1: ["svajciarsko", "pamiatka", "studena"], 2: ["svajciarsko", "pamiatka", "priroda"] },
    },
    {
        ...
        tag: {0: ["kanada", "mesto"], 1: ["kanada", "pamiatka"], 2: ["kanada", "pamiatka"] },
    },
    {
